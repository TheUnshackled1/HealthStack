...
urlpatterns = [
    ...
    path('labworker-test-orders/', views.labworker_test_orders,name='labworker-test-orders'),
    path('labworker-record-payment/<int:pk>/', views.labworker_record_payment,name='labworker-record-payment'),
